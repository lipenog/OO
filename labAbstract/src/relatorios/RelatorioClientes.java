...
public class RelatorioClientes {
    public void geraRelatorio() {
        ...
        for (int indiceCliente = 0; indiceCliente < banco.getNumeroDeClientes(); indiceCliente++) {
            ...
            for (int indiceConta = 0; indiceConta < cliente.getNumeroContas(); indiceConta++) {
                ...
                System.out.println("    " + tipoConta + ": Saldo atual de " + formatoMonetario.format(conta.getSaldo())+ ". ");
                if (isContaCorrente) {
                    ContaCorrente contaCorrente = (ContaCorrente)conta;
                    System.out.println("\tCheque especial de " +
                            (formatoMonetario.format(contaCorrente.getChequeEspecial())));
                }
            }
         }
    }
